...
all-`KMB` repetitions are withheld as ambiguous. Prefix qualifiers remain only
in retained raw evidence text; the quota schema does not represent qualifier
