...
One further test pins the guarantee's **boundary** rather than the guarantee, and
...
asserted at its documented outcome. The boundary is reachable only if something
