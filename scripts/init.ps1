...
Write-Output "FreeTier Atlas F000 initialization checks"
...
Write-Output "Application scaffold checks: pending F002 - no product services are started by F000 initialization"
Write-Output "F000 initialization checks completed"
